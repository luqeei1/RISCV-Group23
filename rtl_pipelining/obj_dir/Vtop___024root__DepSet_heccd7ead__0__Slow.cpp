...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__ALUResult = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__ImmSrcD = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__modeAddrD = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vchglast__TOP__top__DOT__data_memory__DOT__RD = VL_RAND_RESET_I(32);
}
