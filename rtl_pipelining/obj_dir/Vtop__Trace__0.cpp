...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+132,(vlSelf->top__DOT__miss_stall));
    bufp->chgBit(oldp+133,(vlSelf->top__DOT__flushBranch));
    bufp->chgBit(oldp+134,(vlSelf->top__DOT__BPU_Src));
    bufp->chgIData(oldp+135,(vlSelf->top__DOT__PC_predict),32);
    bufp->chgIData(oldp+136,(vlSelf->top__DOT__PC_next),32);
    bufp->chgBit(oldp+137,(vlSelf->top__DOT__BPU_mux__DOT__sel));
    bufp->chgIData(oldp+138,(vlSelf->top__DOT__BPU_mux__DOT__in0),32);
    bufp->chgIData(oldp+139,(vlSelf->top__DOT__BPU_mux__DOT__in1),32);
    bufp->chgIData(oldp+140,(vlSelf->top__DOT__BPU_mux__DOT__out),32);
    bufp->chgBit(oldp+141,(vlSelf->top__DOT__PC_mux__DOT__ZeroE));
    bufp->chgBit(oldp+142,(vlSelf->top__DOT__PC_mux__DOT__JumpE));
    bufp->chgBit(oldp+143,(vlSelf->top__DOT__PC_mux__DOT__BranchE));
    bufp->chgBit(oldp+144,(vlSelf->top__DOT__PC_mux__DOT__JALRE));
    bufp->chgIData(oldp+145,(vlSelf->top__DOT__PC_mux__DOT__PCPlus4F),32);
    bufp->chgIData(oldp+146,(vlSelf->top__DOT__PC_mux__DOT__ALUResult),32);
    bufp->chgIData(oldp+147,(vlSelf->top__DOT__PC_mux__DOT__PCTarget),32);
    bufp->chgIData(oldp+148,(vlSelf->top__DOT__PC_mux__DOT__PC),32);
    bufp->chgIData(oldp+149,(vlSelf->top__DOT__alu__DOT__SrcA),32);
    bufp->chgIData(oldp+150,(vlSelf->top__DOT__alu__DOT__SrcB),32);
    bufp->chgCData(oldp+151,(vlSelf->top__DOT__alu__DOT__ALUctrl),4);
    bufp->chgIData(oldp+152,(vlSelf->top__DOT__alu__DOT__ALUResult),32);
    bufp->chgBit(oldp+153,(vlSelf->top__DOT__alu__DOT__ZeroE));
    bufp->chgBit(oldp+154,(vlSelf->top__DOT__branch_prediction_unit__DOT__clk));
    bufp->chgIData(oldp+155,(vlSelf->top__DOT__branch_prediction_unit__DOT__RD),32);
    bufp->chgIData(oldp+156,(vlSelf->top__DOT__branch_prediction_unit__DOT__PCF),32);
    bufp->chgBit(oldp+157,(vlSelf->top__DOT__branch_prediction_unit__DOT__ZeroE));
    bufp->chgBit(oldp+158,(vlSelf->top__DOT__branch_prediction_unit__DOT__JumpE));
    bufp->chgBit(oldp+159,(vlSelf->top__DOT__branch_prediction_unit__DOT__BranchE));
    bufp->chgBit(oldp+160,(vlSelf->top__DOT__branch_prediction_unit__DOT__flushBranch));
    bufp->chgIData(oldp+161,(vlSelf->top__DOT__branch_prediction_unit__DOT__PCBPU),32);
    bufp->chgBit(oldp+162,(vlSelf->top__DOT__branch_prediction_unit__DOT__PCBPUSrc));
    ...
    __Vtemp_ha8dc2164__0[2U] = vlSelf->top__DOT__branch_prediction_unit__DOT__branch_queue
        [0U][2U];
    bufp->chgWData(oldp+163,(__Vtemp_ha8dc2164__0),66);
    ...
    __Vtemp_ha8dc1e26__0[2U] = vlSelf->top__DOT__branch_prediction_unit__DOT__branch_queue
        [1U][2U];
    bufp->chgWData(oldp+166,(__Vtemp_ha8dc1e26__0),66);
    ...
    __Vtemp_ha8dc1deb__0[2U] = vlSelf->top__DOT__branch_prediction_unit__DOT__branch_queue
        [2U][2U];
    bufp->chgWData(oldp+169,(__Vtemp_ha8dc1deb__0),66);
    ...
    __Vtemp_ha8dc20a8__0[2U] = vlSelf->top__DOT__branch_prediction_unit__DOT__branch_queue
        [3U][2U];
    bufp->chgWData(oldp+172,(__Vtemp_ha8dc20a8__0),66);
    ...
    __Vtemp_ha8dc2065__0[2U] = vlSelf->top__DOT__branch_prediction_unit__DOT__branch_queue
        [4U][2U];
    bufp->chgWData(oldp+175,(__Vtemp_ha8dc2065__0),66);
    ...
    __Vtemp_ha8dc2135__0[2U] = vlSelf->top__DOT__branch_prediction_unit__DOT__branch_queue
        [5U][2U];
    bufp->chgWData(oldp+178,(__Vtemp_ha8dc2135__0),66);
    ...
    __Vtemp_ha8dc20f8__0[2U] = vlSelf->top__DOT__branch_prediction_unit__DOT__branch_queue
        [6U][2U];
    bufp->chgWData(oldp+181,(__Vtemp_ha8dc20f8__0),66);
    ...
    __Vtemp_ha8dc1b7b__0[2U] = vlSelf->top__DOT__branch_prediction_unit__DOT__branch_queue
        [7U][2U];
    bufp->chgWData(oldp+184,(__Vtemp_ha8dc1b7b__0),66);
    ...
    __Vtemp_ha8dc1b76__0[2U] = vlSelf->top__DOT__branch_prediction_unit__DOT__branch_queue
        [8U][2U];
    bufp->chgWData(oldp+187,(__Vtemp_ha8dc1b76__0),66);
    ...
    __Vtemp_ha8dc2034__0[2U] = vlSelf->top__DOT__branch_prediction_unit__DOT__branch_queue
        [9U][2U];
    bufp->chgWData(oldp+190,(__Vtemp_ha8dc2034__0),66);
    ...
    __Vtemp_ha8dc1ff1__0[2U] = vlSelf->top__DOT__branch_prediction_unit__DOT__branch_queue
        [0xaU][2U];
    bufp->chgWData(oldp+193,(__Vtemp_ha8dc1ff1__0),66);
    ...
    __Vtemp_ha8dc52b2__0[2U] = vlSelf->top__DOT__branch_prediction_unit__DOT__branch_queue
        [0xbU][2U];
    bufp->chgWData(oldp+196,(__Vtemp_ha8dc52b2__0),66);
    ...
    __Vtemp_ha8dc5277__0[2U] = vlSelf->top__DOT__branch_prediction_unit__DOT__branch_queue
        [0xcU][2U];
    bufp->chgWData(oldp+199,(__Vtemp_ha8dc5277__0),66);
    ...
    __Vtemp_ha8dc1b33__0[2U] = vlSelf->top__DOT__branch_prediction_unit__DOT__branch_queue
        [0xdU][2U];
    bufp->chgWData(oldp+202,(__Vtemp_ha8dc1b33__0),66);
    ...
    __Vtemp_ha8dc1aee__0[2U] = vlSelf->top__DOT__branch_prediction_unit__DOT__branch_queue
        [0xeU][2U];
    bufp->chgWData(oldp+205,(__Vtemp_ha8dc1aee__0),66);
    ...
    __Vtemp_ha8dc1dad__0[2U] = vlSelf->top__DOT__branch_prediction_unit__DOT__branch_queue
        [0xfU][2U];
    bufp->chgWData(oldp+208,(__Vtemp_ha8dc1dad__0),66);
    bufp->chgCData(oldp+211,(vlSelf->top__DOT__branch_prediction_unit__DOT__queue_front),4);
    bufp->chgCData(oldp+212,(vlSelf->top__DOT__branch_prediction_unit__DOT__queue_back),4);
    bufp->chgCData(oldp+213,(vlSelf->top__DOT__branch_prediction_unit__DOT__queue_count),5);
    bufp->chgWData(oldp+214,(vlSelf->top__DOT__branch_prediction_unit__DOT__newBranch),66);
    bufp->chgWData(oldp+217,(vlSelf->top__DOT__branch_prediction_unit__DOT__oldBranch),66);
    bufp->chgCData(oldp+220,(vlSelf->top__DOT__branch_prediction_unit__DOT__forwardJumpCounter),2);
    bufp->chgCData(oldp+221,(vlSelf->top__DOT__branch_prediction_unit__DOT__backwardJumpCounter),2);
    bufp->chgIData(oldp+222,(vlSelf->top__DOT__control_unit__DOT__InstrD),32);
    bufp->chgCData(oldp+223,(vlSelf->top__DOT__control_unit__DOT__ResultSrcD),2);
    bufp->chgBit(oldp+224,(vlSelf->top__DOT__control_unit__DOT__MemWriteD));
    bufp->chgBit(oldp+225,(vlSelf->top__DOT__control_unit__DOT__JumpD));
    bufp->chgBit(oldp+226,(vlSelf->top__DOT__control_unit__DOT__BranchD));
    bufp->chgBit(oldp+227,(vlSelf->top__DOT__control_unit__DOT__JALRD));
    bufp->chgCData(oldp+228,(vlSelf->top__DOT__control_unit__DOT__ALUControlD),4);
    bufp->chgBit(oldp+229,(vlSelf->top__DOT__control_unit__DOT__ALUSrcD));
    bufp->chgCData(oldp+230,(vlSelf->top__DOT__control_unit__DOT__ImmSrcD),3);
    bufp->chgBit(oldp+231,(vlSelf->top__DOT__control_unit__DOT__RegWriteD));
    bufp->chgCData(oldp+232,(vlSelf->top__DOT__control_unit__DOT__modeAddr),3);
    bufp->chgBit(oldp+233,(vlSelf->top__DOT__control_unit__DOT__MemReadD));
    bufp->chgCData(oldp+234,(vlSelf->top__DOT__control_unit__DOT__op),7);
    bufp->chgCData(oldp+235,(vlSelf->top__DOT__control_unit__DOT__funct3),3);
    bufp->chgBit(oldp+236,(vlSelf->top__DOT__control_unit__DOT__funct7));
    bufp->chgCData(oldp+237,(vlSelf->top__DOT__control_unit__DOT__ALUOp),2);
    bufp->chgBit(oldp+238,(vlSelf->top__DOT__control_unit__DOT__Store));
    bufp->chgBit(oldp+239,(vlSelf->top__DOT__control_unit__DOT__Load));
    bufp->chgCData(oldp+240,(vlSelf->top__DOT__control_unit__DOT__alu_decoder__DOT__ALUOp),2);
    bufp->chgBit(oldp+241,(vlSelf->top__DOT__control_unit__DOT__alu_decoder__DOT__op));
    bufp->chgCData(oldp+242,(vlSelf->top__DOT__control_unit__DOT__alu_decoder__DOT__funct3),3);
    bufp->chgBit(oldp+243,(vlSelf->top__DOT__control_unit__DOT__alu_decoder__DOT__funct7));
    bufp->chgCData(oldp+244,(vlSelf->top__DOT__control_unit__DOT__alu_decoder__DOT__ALUControl),4);
    bufp->chgCData(oldp+245,(vlSelf->top__DOT__data_memory__DOT__modeAddr),3);
    bufp->chgBit(oldp+246,(vlSelf->top__DOT__data_memory__DOT__clk));
    bufp->chgIData(oldp+247,(vlSelf->top__DOT__data_memory__DOT__A),32);
    bufp->chgIData(oldp+248,(vlSelf->top__DOT__data_memory__DOT__WD),32);
    bufp->chgBit(oldp+249,(vlSelf->top__DOT__data_memory__DOT__trigger));
    bufp->chgBit(oldp+250,(vlSelf->top__DOT__data_memory__DOT__WE));
    bufp->chgIData(oldp+251,(vlSelf->top__DOT__data_memory__DOT__RD),32);
    bufp->chgCData(oldp+252,(vlSelf->top__DOT__forwardAE_mux__DOT__sel),2);
    bufp->chgIData(oldp+253,(vlSelf->top__DOT__forwardAE_mux__DOT__in0),32);
    bufp->chgIData(oldp+254,(vlSelf->top__DOT__forwardAE_mux__DOT__in1),32);
    bufp->chgIData(oldp+255,(vlSelf->top__DOT__forwardAE_mux__DOT__in2),32);
    bufp->chgIData(oldp+256,(vlSelf->top__DOT__forwardAE_mux__DOT__in3),32);
    bufp->chgIData(oldp+257,(vlSelf->top__DOT__forwardAE_mux__DOT__out),32);
    bufp->chgCData(oldp+258,(vlSelf->top__DOT__forwardBE_mux__DOT__sel),2);
    bufp->chgIData(oldp+259,(vlSelf->top__DOT__forwardBE_mux__DOT__in0),32);
    bufp->chgIData(oldp+260,(vlSelf->top__DOT__forwardBE_mux__DOT__in1),32);
    bufp->chgIData(oldp+261,(vlSelf->top__DOT__forwardBE_mux__DOT__in2),32);
    bufp->chgIData(oldp+262,(vlSelf->top__DOT__forwardBE_mux__DOT__in3),32);
    bufp->chgIData(oldp+263,(vlSelf->top__DOT__forwardBE_mux__DOT__out),32);
    bufp->chgCData(oldp+264,(vlSelf->top__DOT__hazard_unit__DOT__RdM),5);
    bufp->chgCData(oldp+265,(vlSelf->top__DOT__hazard_unit__DOT__RdW),5);
    bufp->chgCData(oldp+266,(vlSelf->top__DOT__hazard_unit__DOT__RdE),5);
    bufp->chgCData(oldp+267,(vlSelf->top__DOT__hazard_unit__DOT__Rs1E),5);
    bufp->chgCData(oldp+268,(vlSelf->top__DOT__hazard_unit__DOT__Rs2E),5);
    bufp->chgCData(oldp+269,(vlSelf->top__DOT__hazard_unit__DOT__Rs1D),5);
    bufp->chgCData(oldp+270,(vlSelf->top__DOT__hazard_unit__DOT__Rs2D),5);
    bufp->chgBit(oldp+271,(vlSelf->top__DOT__hazard_unit__DOT__RegWriteM));
    bufp->chgBit(oldp+272,(vlSelf->top__DOT__hazard_unit__DOT__RegWriteW));
    bufp->chgBit(oldp+273,(vlSelf->top__DOT__hazard_unit__DOT__MemReadE));
    bufp->chgBit(oldp+274,(vlSelf->top__DOT__hazard_unit__DOT__JumpE));
    bufp->chgBit(oldp+275,(vlSelf->top__DOT__hazard_unit__DOT__MemReadM));
    bufp->chgBit(oldp+276,(vlSelf->top__DOT__hazard_unit__DOT__flushBranch));
    bufp->chgBit(oldp+277,(vlSelf->top__DOT__hazard_unit__DOT__miss_stall));
