...
VL_INLINE_OPT void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if ((((IData)(vlSelfRef.top__DOT__RegWriteM) & 
          ((IData)(vlSelfRef.top__DOT__Rs1E) == (IData)(vlSelfRef.top__DOT__RdM))) 
    ...
    vlSelfRef.top__DOT__data_memory__DOT__RD = ((0x100U 
                                                 == vlSelfRef.top__DOT__ALUResultM)
                                                 ? (IData)(vlSelfRef.trigger)
                                                 : 
                                                ((4U 
                                                  & (IData)(vlSelfRef.top__DOT__modeAddrM))
                                                  ? 
                                                 ((2U 
                                                   & (IData)(vlSelfRef.top__DOT__modeAddrM))
                                                   ? 0U
